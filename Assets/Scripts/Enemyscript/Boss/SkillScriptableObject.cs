...
public class SkillScriptableObject : ScriptableObject
{
    ...
    public virtual void UseSkill(EnemiAI Enemy, Player Player)
    {
        IsActivating = true;
    }

    public virtual bool CanUseSkill(EnemiAI Enemy, Player Player, int Level)
    {
        return !IsActivating
            && Level >= UnlockLevel
    ...
    protected void DisableEnemyMovement(EnemiAI Enemy)
    {
        Enemy.enabled = true;
        //Enemy.Mo
    }
